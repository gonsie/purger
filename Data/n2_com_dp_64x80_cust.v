...
// 
// OpenSPARC T2 Processor File: n2_com_dp_64x80_cust.v
...
`define OUTFLOP_n2_com_dp_64x80_cust  TRUE		
...
// Flop the inputs                                           //
///////////////////////////////////////////////////////////////
n2_com_dp_64x80_cust_msff_ctl_macro__width_6 dff_wr_addr  (
...
n2_com_dp_64x80_cust_sram_msff_mo_macro__fs_1__width_6 dff_rd_addr   (
...
n2_com_dp_64x80_cust_sram_msff_mo_macro__width_1 dff_rd_en  (
...
n2_com_dp_64x80_cust_msff_ctl_macro__width_1 dff_wr_en  (
...
n2_com_dp_64x80_cust_msff_ctl_macro__fs_1__width_40 dff_din_hi   (
	.scan_in	({dff_din_hi_scan[39:1],dff_din_hi_scanin}),
	.scan_out	({dff_din_hi_scanout,dff_din_hi_scan[39:1]}),
	.l1clk		(wrclk_in),
	.din		(din[79:40]),
	.dout		(din_d1[79:40]),
  .siclk(siclk),
...
n2_com_dp_64x80_cust_msff_ctl_macro__fs_1__width_40 dff_din_lo   (
	.scan_in	({dff_din_lo_scan[39:1],dff_din_lo_scanin}),
	.scan_out	({dff_din_lo_scanout,dff_din_lo_scan[39:1]}),
	.l1clk		(wrclk_in),
	.din		(din[39:0]),
	.dout		(din_d1[39:0]),
  .siclk(siclk),
...
n2_com_dp_64x80_cust_inv_macro__width_1 wr_inh_inv  (
	.din		(tcu_array_wr_inhibit),
	.dout		(wr_inh_)
);
n2_com_dp_64x80_cust_and_macro__width_2 enable_qual  (
	.din0		({2{wr_inh_}}),
	.din1		({rd_en_d1,wr_en_d1}),
	.dout		({rd_en_d1_qual,wr_en_d1_qual})
);
n2_com_dp_64x80_cust_n2_com_array_macro__rows_64__width_80__z_array array    (
	.rclk	(rdclk_free),
	.wclk	(wrclk_free),
	...
	.rd_en	(rd_en_d1_qual),
	.din	(din_d1[79:0]),
	.dout	(local_dout[79:0])
);

n2_com_dp_64x80_cust_msff_ctl_macro__width_80 dff_dout  (
...
module n2_com_dp_64x80_cust_msff_ctl_macro__width_6 (
  din, 
  l1clk, 
  scan_in, 
  siclk, 
...
module n2_com_dp_64x80_cust_sram_msff_mo_macro__fs_1__width_6 (
  d, 
  scan_in, 
  l1clk, 
  and_clk, 
...
module n2_com_dp_64x80_cust_sram_msff_mo_macro__width_1 (
  d, 
  scan_in, 
  l1clk, 
  and_clk, 
...
module n2_com_dp_64x80_cust_msff_ctl_macro__width_1 (
  din, 
  l1clk, 
  scan_in, 
  siclk, 
...
module n2_com_dp_64x80_cust_msff_ctl_macro__fs_1__width_40 (
  din, 
  l1clk, 
  scan_in, 
  siclk, 
...
module n2_com_dp_64x80_cust_inv_macro__width_1 (
  din, 
  dout);
  input [0:0] din;
  output [0:0] dout;
...
module n2_com_dp_64x80_cust_and_macro__width_2 (
  din0, 
  din1, 
  dout);
  input [1:0] din0;
...
module n2_com_dp_64x80_cust_n2_com_array_macro__rows_64__width_80__z_array (
  rclk, 
  wclk, 
  rd_adr, 
  rd_en, 
...
reg	[80-1:0]	mem[64-1:0];
reg	[80-1:0]	local_dout;
   ...
   if (rclk) begin
     if (rd_en) begin
         if (wr_en & (wr_adr[5:0] == rd_adr[5:0]))
             local_dout[80-1:0] <= 80'hx;
         else
             local_dout[80-1:0] <= mem[rd_adr] ;
     end
     else
             local_dout[80-1:0] <= ~(80'h0);
  end
end
assign dout[80-1:0] = local_dout[80-1:0];
supply0 vss;
supply1 vdd;
...
module n2_com_dp_64x80_cust_msff_ctl_macro__width_80 (
  din, 
  l1clk, 
  scan_in, 
  siclk, 
