...
//======================================
`define	PCX_WIDTH	130  //PCX payload packet width , BS and
                             //    SR 11/12/03 N2 Xbar Packet format change
`define	PCX_WIDTH_LESS1	129  // Needed for Astro, replacing the
                             //    expression PCX_WIDTH-1
`define	CPX_WIDTH	146  //CPX payload packet width, BS and
                             //    SR 11/12/03 N2 Xbar Packet format change
`define	CPX_WIDTH_LESS1	145  //Needed for Astro, replacing the
                             //    expression CPX_WIDTH-1
`define	CPX_WIDTHc	146c  //CPX payload packet width , BS and
                             //    SR 11/12/03 N2 Xbar Packet format change
