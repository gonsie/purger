...
// 
// OpenSPARC T2 Processor File: n2_com_dp_64x72_cust.v
...
`define OUTFLOP_n2_com_dp_64x72_cust  TRUE		



// define module name here
// ********* DON'T TOUCH NEXT LINE ********* 
module n2_com_dp_64x72_cust (
  wr_adr, 
  wr_en, 
  rd_adr, 
  rd_en, 
...
// Flop the inputs                                           //
///////////////////////////////////////////////////////////////
n2_com_dp_64x72_cust_msff_ctl_macro__width_6 dff_wr_addr  (
...
n2_com_dp_64x72_cust_sram_msff_mo_macro__fs_1__width_6 dff_rd_addr   (
...
n2_com_dp_64x72_cust_sram_msff_mo_macro__width_1 dff_rd_en  (
...
n2_com_dp_64x72_cust_msff_ctl_macro__width_1 dff_wr_en  (
...
n2_com_dp_64x72_cust_msff_ctl_macro__fs_1__width_36 dff_din_hi   (
...
n2_com_dp_64x72_cust_msff_ctl_macro__fs_1__width_36 dff_din_lo   (
...
n2_com_dp_64x72_cust_inv_macro__width_1 wr_inh_inv  (
	.din		(tcu_array_wr_inhibit),
	.dout		(wr_inh_)
);
n2_com_dp_64x72_cust_and_macro__width_2 enable_qual  (
	.din0		({2{wr_inh_}}),
	.din1		({rd_en_d1,wr_en_d1}),
	.dout		({rd_en_d1_qual,wr_en_d1_qual})
);
n2_com_dp_64x72_cust_n2_com_array_macro__rows_64__width_72__z_array array    (
	.rclk	(rdclk_free),
	.wclk	(wrclk_free),
...
n2_com_dp_64x72_cust_msff_ctl_macro__width_72 dff_dout  (
...
module n2_com_dp_64x72_cust_msff_ctl_macro__width_6 (
  din, 
  l1clk, 
  scan_in, 
  siclk, 
...
module n2_com_dp_64x72_cust_sram_msff_mo_macro__fs_1__width_6 (
  d, 
  scan_in, 
  l1clk, 
  and_clk, 
...
module n2_com_dp_64x72_cust_sram_msff_mo_macro__width_1 (
  d, 
  scan_in, 
  l1clk, 
  and_clk, 
...
module n2_com_dp_64x72_cust_msff_ctl_macro__width_1 (
  din, 
  l1clk, 
  scan_in, 
  siclk, 
...
module n2_com_dp_64x72_cust_msff_ctl_macro__fs_1__width_36 (
  din, 
  l1clk, 
  scan_in, 
  siclk, 
...
module n2_com_dp_64x72_cust_inv_macro__width_1 (
  din, 
  dout);
  input [0:0] din;
  output [0:0] dout;
...
module n2_com_dp_64x72_cust_and_macro__width_2 (
  din0, 
  din1, 
  dout);
  input [1:0] din0;
...
module n2_com_dp_64x72_cust_n2_com_array_macro__rows_64__width_72__z_array (
  rclk, 
  wclk, 
  rd_adr, 
  rd_en, 
...
module n2_com_dp_64x72_cust_msff_ctl_macro__width_72 (
  din, 
  l1clk, 
  scan_in, 
  siclk, 
